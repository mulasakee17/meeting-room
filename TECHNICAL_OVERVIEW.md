...
**SwarmAlpha** 是一个 **AI 多智能体集体智能研究平台**，以金融市场为实验环境，模拟具有不同人格、决策框架和信息不对称的 AI Agent 群体如何就市场方向（看涨/看跌/中性）形成共识。

### 核心研究问题

> 给定一条金融新闻事件，在信息不对称的条件下，多个 AI Agent 能否收敛到一个市场方向判断？共识形成的过程是怎样的？什么因素导致稳健共识、脆弱共识或群体极化？
...
*本文档完全基于对 SwarmAlpha 全部源代码（TypeScript/TSX/JSON/Config）的深度分析生成，未参考任何现有 .md 文档。*
