...
export interface GovernanceConfig {
  ...
  /** Intervention ordering policy.
   * - 'fixed' (default): deterministic detector order; no uncalibrated signal controls behavior.
   * - 'legacy_scalar_decomposition_v1': explicit opt-in compatibility heuristic.
   * - 'fdecomposition': deprecated alias of legacy_scalar_decomposition_v1. */
  sortingMode?: "fixed" | "legacy_scalar_decomposition_v1" | "fdecomposition";
}
