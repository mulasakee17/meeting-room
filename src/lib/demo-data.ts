...
export const DEMO_SCENARIOS: DemoScenario[] = [
  {
    ...
    singleAgent: {
      ...
      dimensions: {
        ...
        explainability:  { score: 68,  label: "可解释性" },
        robustness:      { score: 52,  label: "鲁棒性" },
        stability:       { score: 100, label: "稳定性（单人无变化）" },
        manipulation:    { score: 35,  label: "抗操纵性" },
        influence:       { score: 30,  label: "影响分析" },
      },
    ...
    swarmAgents: {
      ...
      overallScore: 82,
      grade: "good",
      summary: "多智能体讨论显著提升了决策质量。多视角交叉验证使得可靠性从 45 提升到 78，抗操纵性从 35 提升到 72。治理引擎未检测到回音室或极化偏差。",
      dimensions: {
        consensus:       { score: 85, label: "共识度" },
        reliability:     { score: 78, label: "可靠性" },
        explainability:  { score: 82, label: "可解释性" },
        robustness:      { score: 76, label: "鲁棒性" },
        stability:       { score: 81, label: "稳定性" },
        manipulation:    { score: 72, label: "抗操纵性" },
        influence:       { score: 84, label: "影响分析" },
      },
      governance: {
  ...
  },
  {
    ...
    singleAgent: {
      ...
      dimensions: {
        ...
        explainability: { score: 55,  label: "可解释性" },
        robustness:     { score: 48,  label: "鲁棒性" },
        stability:      { score: 100, label: "稳定性" },
        manipulation:   { score: 30,  label: "抗操纵性" },
        influence:      { score: 25,  label: "影响分析" },
      },
      governance: undefined,
    ...
    swarmAgents: {
      ...
      dimensions: {
        ...
        explainability: { score: 85, label: "可解释性" },
        robustness:     { score: 80, label: "鲁棒性" },
        stability:      { score: 83, label: "稳定性" },
        manipulation:   { score: 76, label: "抗操纵性" },
        influence:      { score: 86, label: "影响分析" },
      },
      governance: {
  ...
  },
  {
    ...
    singleAgent: {
      ...
      dimensions: {
        ...
        explainability: { score: 52,  label: "可解释性" },
        robustness:     { score: 46,  label: "鲁棒性" },
        stability:      { score: 100, label: "稳定性" },
        manipulation:   { score: 28,  label: "抗操纵性" },
        influence:      { score: 22,  label: "影响分析" },
      },
      governance: undefined,
    ...
    swarmAgents: {
      ...
      overallScore: 88,
      grade: "excellent",
      summary: "多智能体讨论实现了从「是不是优先级」到「什么程度的优先级，如何分配资源」的认知跃迁。可靠性达 86，7 维均分在 80 以上。这是集体智慧超越个人判断的典型案例。",
      dimensions: {
        consensus:      { score: 90, label: "共识度" },
        reliability:    { score: 86, label: "可靠性" },
        explainability: { score: 89, label: "可解释性" },
        robustness:     { score: 84, label: "鲁棒性" },
        stability:      { score: 87, label: "稳定性" },
        manipulation:   { score: 82, label: "抗操纵性" },
        influence:      { score: 91, label: "影响分析" },
      },
      governance: {
